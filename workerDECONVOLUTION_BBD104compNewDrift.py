...
def main_f(set_ifov,try_mode=True):
   ...
   # r'\\merfish6\merfish6v2\DNA_FISH\20230212_R120PVTS32RDNABDNF\'
    ...
    all_flds_ = glob.glob(r'\\merfish8\merfish8v2\20230801D104Myh67d80DNA\DNA\H*B*'+set__) ################################# modify for 3-col small tad 
    redefine_color += [[0,1,2,3]]*len(all_flds_) #### three signal color
    all_flds+=all_flds_

    #X:\20230801D104Myh67d80\DNA (remaining big TAD)
    all_flds_ = glob.glob(r'\\merfish8\merfish8v1\20230801D104Myh67d80\DNA\H*B*'+set__) ################################# modify for 3-col small tad 
    redefine_color += [[0,1,2,3]]*len(all_flds_) #### three signal color
    all_flds+=all_flds_
